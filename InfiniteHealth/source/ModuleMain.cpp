...
static const char* const GML_SCRIPT_MODIFY_HEALTH = "gml_Script_play_text@TextboxMenu@TextboxMenu";
...
{
	if (Arguments[0]->m_Kind == VALUE_STRING)
	{
		std::string s = Arguments[0]->ToString();
		int temp = 5;
	}
