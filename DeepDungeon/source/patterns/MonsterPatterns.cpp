...
void ModifyStalagmiteAttackPatterns(bool is_boss_battle, bool is_outbreak, RValue monster)
{
	...
	if (custom_attack_pattern_exists.ToBoolean() && StructVariableExists(monster, "fsm"))
	{
		...
		if (state_id.ToInt64() == static_cast<int64_t>(MMAPI::Monster::States::Mite::Attack))
			*monster.GetRefMember("__deep_dungeon__wait_to_change_attack_pattern") = false;

		if (state_id.ToInt64() == static_cast<int64_t>(MMAPI::Monster::States::Mite::Tired) && !wait_to_change_attack_pattern.ToBoolean())
		{
...
void ModifySaplingAttackPatterns(bool is_boss_battle, RValue is_outbreak, RValue monster, int monster_id)
{
	...
	if (!custom_attack_pattern_exists.ToBoolean())
	{
		if (StructVariableExists(monster, "config"))
		{
			...
			StructVariableSet(config_clone, "sap_children_species", RValue(MMAPI::Monster::GetInternalName(static_cast<MMAPI::Monster::Ids>(monster_id))));
			...
			if (monster_id == static_cast<int>(MMAPI::Monster::Ids::SaplingPink))
			{
...
void ModifySpiritAttackPatterns(bool is_boss_battle, RValue is_outbreak, RValue monster, int monster_id)
{
	...
	if (!custom_attack_pattern_exists.ToBoolean())
	{
		if (StructVariableExists(monster, "config"))
		{
			...
			if (monster_id == static_cast<int>(MMAPI::Monster::Ids::SpiritPurple))
			{
			...
			if (monster_id == static_cast<int>(MMAPI::Monster::Ids::Spirit))
			{
...
void ModifyCatAttackPatterns(bool is_boss_battle, RValue is_outbreak, RValue monster, int monster_id)
{
	...
	if (!custom_attack_pattern_exists.ToBoolean())
	{
		if (StructVariableExists(monster, "config"))
		{
			...
			if (monster_id == static_cast<int>(MMAPI::Monster::Ids::Cat))
			{
				StructVariableSet(config_clone, "petrified_duration", 60);
				StructVariableSet(config_clone, "petrified_shakes", 10);
			}

			if (monster_id == static_cast<int>(MMAPI::Monster::Ids::CatVoid))
			{
...
void ModifyDreadBeastAttackPatterns(bool is_boss_battle, bool is_outbreak, RValue monster)
{
	...
	if (monster_id == static_cast<int>(MMAPI::Monster::Ids::Rockclod) || monster_id == static_cast<int>(MMAPI::Monster::Ids::RockclodBlue) || monster_id == static_cast<int>(MMAPI::Monster::Ids::RockclodGreen) || monster_id == static_cast<int>(MMAPI::Monster::Ids::RockclodRed)) // TODO: "rockclod_purple" if/when implemented
		ModifyRockClodAttackPatterns(is_boss_battle, is_outbreak, monster);
	if (monster_id == static_cast<int>(MMAPI::Monster::Ids::Stalagmite) || monster_id == static_cast<int>(MMAPI::Monster::Ids::StalagmiteGreen) || monster_id == static_cast<int>(MMAPI::Monster::Ids::StalagmitePurple))
		ModifyStalagmiteAttackPatterns(is_boss_battle, is_outbreak, monster);
	if (monster_id == static_cast<int>(MMAPI::Monster::Ids::Sapling) || monster_id == static_cast<int>(MMAPI::Monster::Ids::SaplingCool) || monster_id == static_cast<int>(MMAPI::Monster::Ids::SaplingBlue) || monster_id == static_cast<int>(MMAPI::Monster::Ids::SaplingPurple) || monster_id == static_cast<int>(MMAPI::Monster::Ids::SaplingOrange) || monster_id == static_cast<int>(MMAPI::Monster::Ids::SaplingPink))
		ModifySaplingAttackPatterns(is_boss_battle, is_outbreak, monster, monster_id);
	if (monster_id == static_cast<int>(MMAPI::Monster::Ids::Mushroom) || monster_id == static_cast<int>(MMAPI::Monster::Ids::MushroomGreen) || monster_id == static_cast<int>(MMAPI::Monster::Ids::MushroomBlue) || monster_id == static_cast<int>(MMAPI::Monster::Ids::MushroomPurple))
		ModifyShroomAttackPatterns(is_boss_battle, is_outbreak, monster);
	if (monster_id == static_cast<int>(MMAPI::Monster::Ids::Enchantern) || monster_id == static_cast<int>(MMAPI::Monster::Ids::EnchanternBlue))
		ModifyEnchanternAttackPatterns(is_boss_battle, is_outbreak, monster);
	if (monster_id == static_cast<int>(MMAPI::Monster::Ids::Spirit) || monster_id == static_cast<int>(MMAPI::Monster::Ids::SpiritPurple))
		ModifySpiritAttackPatterns(is_boss_battle, is_outbreak, monster, monster_id);
	if (monster_id == static_cast<int>(MMAPI::Monster::Ids::Cat) || monster_id == static_cast<int>(MMAPI::Monster::Ids::CatVoid))
		ModifyCatAttackPatterns(is_boss_battle, is_outbreak, monster, monster_id);
	if (monster_id == static_cast<int>(MMAPI::Monster::Ids::Bat) || monster_id == static_cast<int>(MMAPI::Monster::Ids::BatBlue))
		ModifyBatAttackPatterns(is_boss_battle, is_outbreak, monster);
	if (monster_id == static_cast<int>(MMAPI::Monster::Ids::Tome))
		ModifyTomeAttackPatterns(is_boss_battle, is_outbreak, monster);
	if (monster_id == static_cast<int>(MMAPI::Monster::Ids::RockStack))
		ModifyRockStackAttackPatterns(is_boss_battle, is_outbreak, monster);
	if (monster_id == static_cast<int>(MMAPI::Monster::Ids::GriffinStatue))
