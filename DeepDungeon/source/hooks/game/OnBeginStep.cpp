...
// MMAPI Anchor::Hooks::BeforeBeginStep callback — fires before the game's per-frame Anchor on_begin_step.
// Registered in Init.cpp via MMAPI::Anchor::Hooks::BeforeBeginStep(BeforeBeginStep).
