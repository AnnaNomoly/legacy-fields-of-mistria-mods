...
bool FairyBuffIsActive()
{
	...
	if (StructVariableExists(inner, std::to_string(static_cast<int>(MMAPI::StatusEffect::Ids::Fairy)).c_str()))
	{
		RValue fairy_status = inner.GetMember(std::to_string(static_cast<int>(MMAPI::StatusEffect::Ids::Fairy)));
...
void DisableAllPerks()
{
	...
	// Cooking Perks
	perks_to_disable.insert(static_cast<int>(MMAPI::Perk::Ids::Snacktime));
...
void MarkDungeonTutorialUnseen()
{
	...
	g_ModuleInterface->GetArrayEntry(tutorials_seen, static_cast<int>(MMAPI::Tutorial::Ids::Mines), mines_tutorial);
...
{
	ari_resource_to_value_map[AriResources::HEALTH] = MMAPI::Player::GetHealth().ToInt64();
	ari_resource_to_value_map[AriResources::MAX_HEALTH] = MMAPI::Player::GetMaxHealth().ToInt64();
	ari_resource_to_value_map[AriResources::STAMINA] = MMAPI::Player::GetStamina().ToInt64();
	ari_resource_to_value_map[AriResources::MANA] = MMAPI::Player::GetMana().ToInt64();
}
...
void UnlockLiftKeyRecipe(CInstance* Self, CInstance* Other)
{
	...
	if (floor_number == 5)
		UnlockRecipe(item_name_to_id_map[UPPER_MINES_KEY_F5_NAME]);
	else if (floor_number == 10)
		UnlockRecipe(item_name_to_id_map[UPPER_MINES_KEY_F10_NAME]);
	else if (floor_number == 15)
		UnlockRecipe(item_name_to_id_map[UPPER_MINES_KEY_F15_NAME]);
	else if (floor_number == 20)
		UnlockRecipe(item_name_to_id_map[TIDE_CAVERNS_KEY_F20_NAME]);
	else if (floor_number == 25)
		UnlockRecipe(item_name_to_id_map[TIDE_CAVERNS_KEY_F25_NAME]);
	else if (floor_number == 30)
		UnlockRecipe(item_name_to_id_map[TIDE_CAVERNS_KEY_F30_NAME]);
	else if (floor_number == 35)
		UnlockRecipe(item_name_to_id_map[TIDE_CAVERNS_KEY_F35_NAME]);
	else if (floor_number == 40)
		UnlockRecipe(item_name_to_id_map[DEEP_EARTH_KEY_F40_NAME]);
	else if (floor_number == 45)
		UnlockRecipe(item_name_to_id_map[DEEP_EARTH_KEY_F45_NAME]);
	else if (floor_number == 50)
		UnlockRecipe(item_name_to_id_map[DEEP_EARTH_KEY_F50_NAME]);
	else if (floor_number == 55)
		UnlockRecipe(item_name_to_id_map[DEEP_EARTH_KEY_F55_NAME]);
	else if (floor_number == 60)
		UnlockRecipe(item_name_to_id_map[LAVA_CAVES_KEY_F60_NAME]);
	else if (floor_number == 65)
		UnlockRecipe(item_name_to_id_map[LAVA_CAVES_KEY_F65_NAME]);
	else if (floor_number == 70)
		UnlockRecipe(item_name_to_id_map[LAVA_CAVES_KEY_F70_NAME]);
	else if (floor_number == 75)
		UnlockRecipe(item_name_to_id_map[LAVA_CAVES_KEY_F75_NAME]);
	else if (floor_number == 80)
		UnlockRecipe(item_name_to_id_map[RUINS_KEY_F80_NAME]);
	else if (floor_number == 85)
		UnlockRecipe(item_name_to_id_map[RUINS_KEY_F85_NAME]);
	else if (floor_number == 90)
		UnlockRecipe(item_name_to_id_map[RUINS_KEY_F90_NAME]);
	else if (floor_number == 95)
		UnlockRecipe(item_name_to_id_map[RUINS_KEY_F95_NAME]);
	else if (floor_number == 100)
		UnlockRecipe(item_name_to_id_map[RUINS_KEY_F100_NAME]);
}

void DropLiftKey()
{
	if(floor_number >= 95)
		MMAPI::Item::Drop(item_name_to_id_map[RUINS_KEY_F95_NAME], ari_x, ari_y);
	else if (floor_number >= 90)
		MMAPI::Item::Drop(item_name_to_id_map[RUINS_KEY_F90_NAME], ari_x, ari_y);
	else if (floor_number >= 85)
		MMAPI::Item::Drop(item_name_to_id_map[RUINS_KEY_F85_NAME], ari_x, ari_y);
	else if (floor_number >= 80)
		MMAPI::Item::Drop(item_name_to_id_map[RUINS_KEY_F80_NAME], ari_x, ari_y);
	else if (floor_number >= 75)
		MMAPI::Item::Drop(item_name_to_id_map[LAVA_CAVES_KEY_F75_NAME], ari_x, ari_y);
	else if (floor_number >= 70)
		MMAPI::Item::Drop(item_name_to_id_map[LAVA_CAVES_KEY_F70_NAME], ari_x, ari_y);
	else if (floor_number >= 65)
		MMAPI::Item::Drop(item_name_to_id_map[LAVA_CAVES_KEY_F65_NAME], ari_x, ari_y);
	else if (floor_number >= 60)
		MMAPI::Item::Drop(item_name_to_id_map[LAVA_CAVES_KEY_F60_NAME], ari_x, ari_y);
	else if (floor_number >= 55)
		MMAPI::Item::Drop(item_name_to_id_map[DEEP_EARTH_KEY_F55_NAME], ari_x, ari_y);
	else if (floor_number >= 50)
		MMAPI::Item::Drop(item_name_to_id_map[DEEP_EARTH_KEY_F50_NAME], ari_x, ari_y);
	else if (floor_number >= 45)
		MMAPI::Item::Drop(item_name_to_id_map[DEEP_EARTH_KEY_F45_NAME], ari_x, ari_y);
	else if (floor_number >= 40)
		MMAPI::Item::Drop(item_name_to_id_map[DEEP_EARTH_KEY_F40_NAME], ari_x, ari_y);
	else if (floor_number >= 35)
		MMAPI::Item::Drop(item_name_to_id_map[TIDE_CAVERNS_KEY_F35_NAME], ari_x, ari_y);
	else if (floor_number >= 30)
		MMAPI::Item::Drop(item_name_to_id_map[TIDE_CAVERNS_KEY_F30_NAME], ari_x, ari_y);
	else if (floor_number >= 25)
		MMAPI::Item::Drop(item_name_to_id_map[TIDE_CAVERNS_KEY_F25_NAME], ari_x, ari_y);
	else if (floor_number >= 20)
		MMAPI::Item::Drop(item_name_to_id_map[TIDE_CAVERNS_KEY_F20_NAME], ari_x, ari_y);
	else if (floor_number >= 15)
		MMAPI::Item::Drop(item_name_to_id_map[UPPER_MINES_KEY_F15_NAME], ari_x, ari_y);
	else if (floor_number >= 10)
		MMAPI::Item::Drop(item_name_to_id_map[UPPER_MINES_KEY_F10_NAME], ari_x, ari_y);
	else if (floor_number >= 5)
		MMAPI::Item::Drop(item_name_to_id_map[UPPER_MINES_KEY_F5_NAME], ari_x, ari_y);
}
