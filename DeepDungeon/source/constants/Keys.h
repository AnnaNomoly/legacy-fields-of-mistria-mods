...
static const std::string DREAD_CONTRACT_RESTRICTED_NOTIFICATION_KEY = "Notifications/Mods/Deep Dungeon/dread_contract_restricted";
...
static const std::string DREAD_CONTRACT_LIMIT_NOTIFICATION_KEY = "Notifications/Mods/Deep Dungeon/dread_contract_limit";
static const std::string DREAD_CONTRACT_BIOME_NOTIFICATION_KEY = "Notifications/Mods/Deep Dungeon/dread_contract_biome";
...
static const std::string CHALLENGE_MODE_BIOME_CLEARED_NOTIFICATION_KEY = "Notifications/Mods/Deep Dungeon/Challenge Mode/biome_cleared";
static const std::string CHALLENGE_MODE_FAILED_NOTIFICATION_KEY = "Notifications/Mods/Deep Dungeon/Challenge Mode/failed";
static const std::string CHALLENGE_MODE_COMPLETED_NOTIFICATION_KEY = "Notifications/Mods/Deep Dungeon/Challenge Mode/completed";
static const std::string CHALLENGE_MODE_ALREADY_COMPLETED_NOTIFICATION_KEY = "Notifications/Mods/Deep Dungeon/Challenge Mode/already_completed";
...
static const std::string UPPER_MINES_DREAD_CONTRACT_DESCRIPTION_LOCALIZED_TEXT_KEY = "Items/Mods/Deep Dungeon/Dread Contracts/upper_mines/description";
static const std::string TIDE_CAVERNS_DREAD_CONTRACT_DESCRIPTION_LOCALIZED_TEXT_KEY = "Items/Mods/Deep Dungeon/Dread Contracts/tide_caverns/description";
static const std::string DEEP_EARTH_DREAD_CONTRACT_DESCRIPTION_LOCALIZED_TEXT_KEY = "Items/Mods/Deep Dungeon/Dread Contracts/deep_earth/description";
static const std::string LAVA_CAVES_DREAD_CONTRACT_DESCRIPTION_LOCALIZED_TEXT_KEY = "Items/Mods/Deep Dungeon/Dread Contracts/lava_caves/description";
static const std::string RUINS_DREAD_CONTRACT_DESCRIPTION_LOCALIZED_TEXT_KEY = "Items/Mods/Deep Dungeon/Dread Contracts/ruins/description";
