...
static const char* const GML_SCRIPT_STORE_MENU_INITIALIZE = "gml_Script_init@StoreMenu@StoreMenu";
static const char* const GML_SCRIPT_STORE_MENU_CLOSE = "gml_Script_anon@10878@StoreMenu@StoreMenu";
